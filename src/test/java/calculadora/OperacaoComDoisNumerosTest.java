...
public class OperacaoComDoisNumerosTest {
    ...
    public static void setup() {
        ...
        try {
            File inputFile = new File("src/test/resources/casos_operacao_dois_numeros.xml");
    ...
    @Test
    public void operacaoComDoisNumerosTeste() {
        for (int procedimentoIndex = 0; procedimentoIndex < listaProcedimentos.getLength(); procedimentoIndex++) {
            ...
            for (int casoIndex = 0; casoIndex < casos.getLength(); casoIndex++) {
                ...
                String operacao = caso.getElementsByTagName("operacao").item(0).getTextContent();

                painel.sendKeys(numero1, operacao, numero2, Keys.ENTER);
