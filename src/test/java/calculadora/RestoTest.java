...
public class RestoTest {
    ...
    public static void setup() {
        ...
        try {
            File inputFile = new File("src/test/resources/casos_resto.xml");
    ...
    public void restoTeste() {
        for (int procedimentoIndex = 0; procedimentoIndex < listaProcedimentos.getLength(); procedimentoIndex++) {
            ...
            for (int casoIndex = 0; casoIndex < casos.getLength(); casoIndex++) {
                ...
                WebElement restoBotao = driver.findElement(By.cssSelector("#b7"));
                WebElement igualBotao = driver.findElement(By.cssSelector("#b27"));
                painel.sendKeys(numero1);
                restoBotao.click();
                painel.sendKeys(numero2);
                igualBotao.click();
